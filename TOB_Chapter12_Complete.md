...
In 2025 researchers Pradyumna Shyama Prasad and Minh Nhat Nguyen ran sixty three-round debates between ten state-of-the-art language models, having each side privately rate its own odds of winning after every round.¹² The models started overconfident — an average of 72.9 percent, against a rational baseline of 50 — and did not correct as the debate went on. They got more confident. By the final round, average confidence had climbed to 83 percent, despite each model having just heard its opponent's counterargument. In 61.7 percent of the debates, both sides simultaneously claimed at least a 75 percent chance of winning — a mathematical impossibility, since both cannot be more likely than not to win the same debate. Even when the researchers explicitly told a model it was debating an identical copy of itself and therefore had exactly even odds, its confidence still rose above 50 percent.

That is certainty filtering the evidence that reaches it, measured directly: the opposing argument arrived, and instead of updating the model toward less certainty, it produced more. Ask an AI system to evaluate its own position in an argument and you are asking a system with a documented tendency to grow more confident precisely when it is being contradicted. Ask instead for a probability estimate before the exchange and again after, and require it to explain what specifically in the other side's argument moved the number — if the number moved at all, and in which direction, tells you whether you are looking at genuine evidence-weighing or the debate equivalent of Semmelweis's opponents finding new ways to file away what did not fit.
